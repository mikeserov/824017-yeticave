...
$lots = array(
                array("item" => "2014 Rossignol District Snowboard",
                    "category" => "Доски и лыжи",
                    "price" => 10999,
                    "URL" => "img/lot-1.jpg"),
                array("item" => "DC Ply Mens 2016/2017 Snowboard",
                    "category" => "Доски и лыжи",
                    "price" => 159999,
                    "URL" => "img/lot-2.jpg"),
                array("item" => "Крепления Union Contact Pro 2015 года размер L/XL",
                    "category" => "Крепления",
                    "price" => 8000,
                    "URL" => "img/lot-3.jpg"),
                array("item" => "Ботинки для сноуборда DC Mutiny Charocal",
                    "category" => "Ботинки",
                    "price" => 10999,
                    "URL" => "img/lot-4.jpg"),
                array("item" => "Куртка для сноуборда DC Mutiny Charocal",
                    "category" => "Одежда",
                    "price" => 7500,
                    "URL" => "img/lot-5.jpg"),
                array("item" => "Маска Oakley Canopy",
                    "category" => "Разное",
                    "price" => 5400,
                    "URL" => "img/lot-6.jpg")
            );
            ...
            <?php foreach($lots as $value): ?>
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="<?= $value["URL"] ?>" width="350" height="260" alt="<?= $value["item"] ?>">
                    </div>
                    <div class="lot__info">
                        <span class="lot__category"><?= $value["category"] ?></span>
                        <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?= $value["item"] ?></a></h3>
