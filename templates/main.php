        ...
        <ul class="promo__list">
            <?php foreach ($categories as $value): ?>
                <li class="promo__item promo__item--<?= $value['name_en'] ?>">
                    <a class="promo__link" href="all_lots.php?category=<?= $value['name_ru']; ?>"><?= $value['name_ru'] ?></a>
                </li>
            <?php endforeach; ?>
        </ul>
    </section>
                    ...
                    <div class="lot__info">
                        ...
                        <div class="lot__state">
                            <div class="lot__rate">
                                ...
                                <span class="lot__cost"><?= my_number_format(esc($value['start_price'])); ?><b class="rub">р</b></span>
                            </div>
